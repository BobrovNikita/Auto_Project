...
{
    public partial class CarProductView : Form, ICarProductView
    {
        ...
        public CarViewModel CarId
        {
            get => (CarViewModel)CarCmb.SelectedItem;
            set => CarCmb.SelectedItem = value;
        }
        ...
        public void SetCarProductBindingSource(BindingSource source)
        {
        ...
        {
            CarCmb.DataSource = source;
            CarCmb.DisplayMember = "CarModel";
            CarCmb.ValueMember = "CarId";
        }

        private static CarProductView? instance;

        public static CarProductView GetInstance(Form parentContainer)
        {
